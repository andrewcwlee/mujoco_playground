...
from mujoco_playground._src.manipulation.av_aloha import cube_pickup as av_aloha_pickup
...
_envs = {
    ...
    "AvAlohaCubePickup": av_aloha_pickup.CubePickup,
...
_cfgs = {
    ...
    "AvAlohaCubePickup": av_aloha_pickup.default_config,
